...
EXPORT_SYMBOL_GPL(__bio_queue_enter); // profiling

void blk_queue_exit(struct request_queue *q)
{
	percpu_ref_put(&q->q_usage_counter);
}
EXPORT_SYMBOL_GPL(blk_queue_exit); // profiling
...
EXPORT_SYMBOL_GPL(submit_bio_noacct_nocheck); // profiling
...
EXPORT_SYMBOL_GPL(update_io_ticks); // profiling
