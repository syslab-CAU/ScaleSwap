...
EXPORT_SYMBOL_GPL(__blk_mq_tag_busy); // profiling
...
EXPORT_SYMBOL_GPL(blk_mq_get_tags); // profiling
...
EXPORT_SYMBOL_GPL(blk_mq_get_tag); // profiling
...
EXPORT_SYMBOL_GPL(blk_mq_put_tag); // profiling
