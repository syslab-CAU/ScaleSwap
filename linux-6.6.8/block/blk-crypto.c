...
EXPORT_SYMBOL_GPL(__blk_crypto_rq_get_keyslot); // profiling
...
EXPORT_SYMBOL_GPL(__blk_crypto_bio_prep); // profiling
...
EXPORT_SYMBOL_GPL(__blk_crypto_rq_bio_prep); // profiling
