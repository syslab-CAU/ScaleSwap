...
EXPORT_SYMBOL_GPL(__tracepoint_iocost_inuse_adjust); // profiling
EXPORT_SYMBOL_GPL(__tracepoint_iocost_iocg_activate); // profiling
EXPORT_SYMBOL_GPL(__SCK__tp_func_iocost_iocg_activate); // profiling
EXPORT_SYMBOL_GPL(__SCT__tp_func_iocost_iocg_activate); // profiling
EXPORT_SYMBOL_GPL(__SCT__tp_func_iocost_inuse_adjust); // profiling
EXPORT_SYMBOL_GPL(__SCK__tp_func_iocost_inuse_adjust); // profiling
