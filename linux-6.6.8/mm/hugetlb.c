...
EXPORT_SYMBOL(hugetlb_vma_unlock_write);
...
EXPORT_SYMBOL(hugetlb_vma_trylock_write);
...
EXPORT_SYMBOL_GPL(size_to_hstate); // profiling
...
EXPORT_SYMBOL_GPL(free_huge_folio); // profiling
...
EXPORT_SYMBOL(hugetlb_basepage_index);
...
EXPORT_SYMBOL_GPL(alloc_hugetlb_folio_vma); // profiling
...
EXPORT_SYMBOL_GPL(copy_hugetlb_page_range); // profiling
...
EXPORT_SYMBOL_GPL(__unmap_hugepage_range); // profiling
...
EXPORT_SYMBOL_GPL(__hugetlb_zap_begin); // profiling
...
EXPORT_SYMBOL_GPL(__hugetlb_zap_end); // profiling
...
EXPORT_SYMBOL_GPL(hugetlb_fault);
...
EXPORT_SYMBOL(adjust_range_if_pmd_sharing_possible);
EXPORT_SYMBOL(huge_pmd_unshare);
...
EXPORT_SYMBOL_GPL(isolate_hugetlb); // profiling
