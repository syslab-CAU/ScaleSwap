...
EXPORT_SYMBOL_GPL(pgd_clear_bad); // profiling
...
EXPORT_SYMBOL_GPL(p4d_clear_bad); // profiling
#endif
...
EXPORT_SYMBOL_GPL(pud_clear_bad); // profiling
#endif
...
EXPORT_SYMBOL_GPL(pmd_clear_bad); // profiling
...
EXPORT_SYMBOL_GPL(ptep_clear_flush); // profiling
#endif
...
EXPORT_SYMBOL_GPL(__pte_offset_map); // profiling
...
EXPORT_SYMBOL_GPL(pte_offset_map_nolock); // profiling
...
EXPORT_SYMBOL_GPL(__pte_offset_map_lock); // profiling
