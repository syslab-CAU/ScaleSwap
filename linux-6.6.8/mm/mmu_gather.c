...
EXPORT_SYMBOL_GPL(tlb_flush_rmaps); // profiling
#endif
...
EXPORT_SYMBOL_GPL(__tlb_remove_page_size); // profiling
...
EXPORT_SYMBOL_GPL(tlb_flush_mmu); // profiling
...
EXPORT_SYMBOL_GPL(tlb_gather_mmu); // profiling
...
EXPORT_SYMBOL_GPL(tlb_finish_mmu); // profiling
