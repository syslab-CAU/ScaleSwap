...
EXPORT_SYMBOL_GPL(compaction_defer_reset); // profiling
...
EXPORT_SYMBOL_GPL(isolate_freepages_range); // profiling
...
EXPORT_SYMBOL_GPL(isolate_migratepages_range); // profiling
...
EXPORT_SYMBOL_GPL(compaction_suitable); // profiling
...
EXPORT_SYMBOL_GPL(compaction_zonelist_suitable); // profiling
...
EXPORT_SYMBOL_GPL(try_to_compact_pages); // profiling
