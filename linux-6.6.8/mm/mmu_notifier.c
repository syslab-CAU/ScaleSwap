...
EXPORT_SYMBOL_GPL(__mmu_notifier_change_pte); // profiling
...
EXPORT_SYMBOL_GPL(__mmu_notifier_invalidate_range_start); // profiling
...
EXPORT_SYMBOL_GPL(__mmu_notifier_invalidate_range_end); // profiling
