...
EXPORT_SYMBOL(anon_vma_cachep);
struct kmem_cache *anon_vma_chain_cachep;
...
EXPORT_SYMBOL_GPL(__anon_vma_prepare); // profiling
...
EXPORT_SYMBOL_GPL(unlink_anon_vmas); // profiling
...
EXPORT_SYMBOL_GPL(try_to_unmap_flush); // profiling
...
EXPORT_SYMBOL_GPL(try_to_unmap_flush_dirty); // profiling
 ...
 */
bool should_defer_flush(struct mm_struct *mm, enum ttu_flags flags)
{
...
EXPORT_SYMBOL_GPL(flush_tlb_batched_pending); // profiling
#else
void set_tlb_ubc_flush_pending(struct mm_struct *mm, pte_t pteval,
				      unsigned long uaddr)
{
...
EXPORT_SYMBOL(set_tlb_ubc_flush_pending);
EXPORT_SYMBOL(should_defer_flush);
...
EXPORT_SYMBOL_GPL(page_address_in_vma); // profiling
...
EXPORT_SYMBOL_GPL(folio_referenced); // profiling
...
EXPORT_SYMBOL(folio_total_mapcount);
...
EXPORT_SYMBOL_GPL(page_move_anon_rmap); // profiling
...
EXPORT_SYMBOL_GPL(page_add_anon_rmap); // profiling
...
EXPORT_SYMBOL_GPL(folio_add_new_anon_rmap); // profiling
...
EXPORT_SYMBOL_GPL(folio_add_file_rmap_range); // profiling
...
EXPORT_SYMBOL_GPL(page_add_file_rmap); // profiling
...
EXPORT_SYMBOL_GPL(page_remove_rmap); // profiling
...
EXPORT_SYMBOL_GPL(try_to_unmap); // profiling
