...
EXPORT_SYMBOL(mlock_drain_percpu);
...
EXPORT_SYMBOL(mlock_drain_local);
...
EXPORT_SYMBOL_GPL(mlock_drain_remote); // profiling

bool need_mlock_drain(int cpu)
{
	return folio_batch_count(&per_cpu(mlock_fbatch.fbatch, cpu));
}
EXPORT_SYMBOL(need_mlock_drain);
