...
EXPORT_SYMBOL_GPL(vm_events_fold_cpu); // profiling
...
EXPORT_SYMBOL_GPL(cpu_vm_stats_fold); // profiling
...
EXPORT_SYMBOL_GPL(drain_zonestat); // profiling
#endif
...
EXPORT_SYMBOL_GPL(sum_zone_node_page_state); // profiling
...
EXPORT_SYMBOL_GPL(node_page_state); // profiling
#endif
