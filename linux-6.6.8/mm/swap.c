...
int page_cluster;
EXPORT_SYMBOL_GPL(page_cluster); // profiling
...
DEFINE_PER_CPU(struct lru_rotate, lru_rotate) = {
	.lock = INIT_LOCAL_LOCK(lock),
};
EXPORT_PER_CPU_SYMBOL(lru_rotate);
...
EXPORT_PER_CPU_SYMBOL(cpu_fbatches);
...
EXPORT_SYMBOL_GPL(lru_note_cost); // profiling
...
EXPORT_SYMBOL(lru_note_cost_refault);
...
EXPORT_SYMBOL_GPL(folio_add_lru_vma); // profiling
...
EXPORT_SYMBOL_GPL(lru_add_drain_cpu); // profiling
...
EXPORT_SYMBOL_GPL(deactivate_file_folio); // profiling
...
void mlock_drain_percpu(int cpu);
...
EXPORT_SYMBOL_GPL(lru_add_drain); // profiling
...
EXPORT_SYMBOL_GPL(lru_disable_count); // profiling
...
EXPORT_SYMBOL_GPL(lru_cache_disable); // profiling
...
EXPORT_SYMBOL_GPL(folio_batch_remove_exceptionals); // profiling
