...
EXPORT_SYMBOL_GPL(__filemap_remove_folio); // profiling
...
EXPORT_SYMBOL_GPL(filemap_free_folio); // profiling
...
EXPORT_SYMBOL_GPL(filemap_remove_folio); // profiling
...
EXPORT_SYMBOL_GPL(delete_from_page_cache_batch); // profiling
...
EXPORT_SYMBOL_GPL(folio_waitqueue); // profiling
...
EXPORT_SYMBOL_GPL(wake_page_function); // profiling
...
EXPORT_SYMBOL_GPL(folio_trylock_flag); // profiling
...
EXPORT_SYMBOL_GPL(__folio_lock_or_retry); // profiling
...
EXPORT_SYMBOL_GPL(find_get_entries); // profiling
...
EXPORT_SYMBOL_GPL(find_lock_entries); // profiling
