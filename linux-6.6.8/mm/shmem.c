 ...
 */
int (*shmem_writepage_module)(struct page *page, struct writeback_control *wbc) = NULL;
EXPORT_SYMBOL(shmem_writepage_module);

static int shmem_writepage(struct page *page, struct writeback_control *wbc)
{
	if (shmem_writepage_module)
		return (*shmem_writepage_module)(page, wbc);
