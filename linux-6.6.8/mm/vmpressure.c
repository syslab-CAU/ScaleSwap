...
EXPORT_SYMBOL_GPL(vmpressure); // profiling
...
EXPORT_SYMBOL_GPL(vmpressure_prio); // profiling
...
EXPORT_SYMBOL(vmpressure_register_event);
...
EXPORT_SYMBOL(vmpressure_unregister_event);
...
EXPORT_SYMBOL(vmpressure_cleanup);
