...
EXPORT_SYMBOL_GPL(policy_zone); // profiling
...
EXPORT_SYMBOL_GPL(get_task_policy); // profiling
...
EXPORT_SYMBOL_GPL(__mpol_put); // profiling
...
EXPORT_SYMBOL_GPL(__get_vma_policy); // profiling
...
EXPORT_SYMBOL_GPL(policy_nodemask); // profiling
 ...
 */
struct folio *(*vma_alloc_folio_module)(gfp_t gfp, int order, struct vm_area_struct *vma,
		unsigned long addr, bool hugepage) = NULL;
EXPORT_SYMBOL(vma_alloc_folio_module);

struct folio *vma_alloc_folio(gfp_t gfp, int order, struct vm_area_struct *vma,
		unsigned long addr, bool hugepage)
{
	if (vma_alloc_folio_module)
		return (*vma_alloc_folio_module)(gfp, order, vma, addr, hugepage);
...
EXPORT_SYMBOL_GPL(mpol_misplaced); // profiling
