...
static int iomap_swapfile_add_extent(struct iomap_swapfile_info *isi)
{
	 ...
	 */
	// printk("[iomap_swapfile_add_extent] iomap->addr: %u\n", iomap->addr);
	first_ppage = ALIGN(iomap->addr, PAGE_SIZE) >> PAGE_SHIFT;
	next_ppage = ALIGN_DOWN(iomap->addr + iomap->length, PAGE_SIZE) >>
			PAGE_SHIFT;
	
	// printk("[iomap_swapfile_add_extent] first_ppage: %u\n", first_ppage);
	// printk("[iomap_swapfile_add_extent] next_ppage: %u\n", next_ppage);
	...
	// printk("[iomap_swapfile_add_extent] nr_pages: %u\n", nr_pages);
	...
	// printk("[iomap_swapfile_add_extent] isi->nr_pages: %u\n", isi->nr_pages);
		...
		const struct iomap_ops *ops)
{
	...
	int ret;
	// printk("[iomap_swapfile_activate] iter->len: %u\n", iter.len);
	// printk("[iomap_swapfile_activate] i_size_read(inode): %u\n", i_size_read(inode));
