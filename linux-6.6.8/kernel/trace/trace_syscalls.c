...
EXPORT_SYMBOL_GPL(enter_syscall_print_funcs); // profiling

struct trace_event_functions exit_syscall_print_funcs = {
	.trace		= print_syscall_exit,
};
EXPORT_SYMBOL_GPL(exit_syscall_print_funcs); // profiling
...
EXPORT_SYMBOL_GPL(event_class_syscall_enter); // profiling
...
EXPORT_SYMBOL_GPL(event_class_syscall_exit); // profiling
