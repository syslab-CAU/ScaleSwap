...
EXPORT_SYMBOL_GPL(delayacct_key); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_freepages_start); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_freepages_end); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_thrashing_start); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_thrashing_end); // profiling

void __delayacct_swapin_start(void)
{
	current->delays->swapin_start = local_clock();
}
EXPORT_SYMBOL(__delayacct_swapin_start);
...
EXPORT_SYMBOL(__delayacct_swapin_end);

void __delayacct_compact_start(void)
{
	current->delays->compact_start = local_clock();
}
EXPORT_SYMBOL_GPL(__delayacct_compact_start); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_compact_end); // profiling

void __delayacct_wpcopy_start(void)
{
	current->delays->wpcopy_start = local_clock();
}
EXPORT_SYMBOL_GPL(__delayacct_wpcopy_start); // profiling
...
EXPORT_SYMBOL_GPL(__delayacct_wpcopy_end); // profiling
