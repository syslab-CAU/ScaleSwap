...
EXPORT_SYMBOL_GPL(cpusets_pre_enable_key); // profiling
EXPORT_SYMBOL_GPL(cpusets_enabled_key); // profiling
...
EXPORT_SYMBOL_GPL(cpusets_insane_config_key); // profiling
...
EXPORT_SYMBOL_GPL(current_cpuset_is_being_rebound); // profiling
...
EXPORT_SYMBOL_GPL(cpuset_mems_allowed); // profiling
...
EXPORT_SYMBOL_GPL(cpuset_nodemask_valid_mems_allowed); // profiling
...
EXPORT_SYMBOL_GPL(cpuset_node_allowed); // profiling
...
EXPORT_SYMBOL_GPL(cpuset_print_current_mems_allowed); // profiling
...
EXPORT_SYMBOL_GPL(cpuset_memory_pressure_enabled); // profiling
...
EXPORT_SYMBOL_GPL(__cpuset_memory_pressure_bump); // profiling
