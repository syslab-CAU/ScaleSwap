...
EXPORT_SYMBOL_GPL(track_pfn_copy); // profiling
...
EXPORT_SYMBOL_GPL(track_pfn_insert); // profiling
...
EXPORT_SYMBOL_GPL(untrack_pfn); // profiling
...
EXPORT_SYMBOL_GPL(untrack_pfn_clear); // profiling
