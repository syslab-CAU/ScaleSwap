...
EXPORT_SYMBOL_GPL(__userpte_alloc_gfp); // profiling
...
EXPORT_SYMBOL_GPL(___pte_free_tlb); // profiling
...
EXPORT_SYMBOL_GPL(___pmd_free_tlb); // profiling
...
EXPORT_SYMBOL_GPL(___pud_free_tlb); // profiling
...
EXPORT_SYMBOL_GPL(___p4d_free_tlb); // profiling
...
EXPORT_SYMBOL_GPL(ptep_set_access_flags); // profiling
...
EXPORT_SYMBOL_GPL(pte_mkwrite); // profiling
...
EXPORT_SYMBOL_GPL(arch_check_zapped_pte); // profiling
