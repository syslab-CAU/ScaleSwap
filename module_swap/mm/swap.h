...
extern void __m_mem_cgroup_uncharge_swap(swp_entry_t entry, unsigned int nr_pages);
static inline void _m_mem_cgroup_uncharge_swap(swp_entry_t entry, unsigned int nr_pages) {
	if (mem_cgroup_disabled())
		return;
	__m_mem_cgroup_uncharge_swap(entry, nr_pages);
}
#else /* CONFIG_SWAP */
struct swap_iocb;
